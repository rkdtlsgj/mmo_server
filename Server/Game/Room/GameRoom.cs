...
namespace Server.Game
{
    public partial class GameRoom : JobSerializer
    {
        ...
        {
            List<Zone> zones = GetAdjsacentZones(pos);
        ...
        {
            List<Zone> zones = GetAdjsacentZones(cellPos, range);
            return zones.SelectMany(z => z.Players).ToList();
        }

        public List<Zone> GetAdjsacentZones(Vector2Int cellPos, int range = VisionCells)
        {
