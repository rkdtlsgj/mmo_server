...
namespace Server
{
    public partial class ClientSession : PacketSession
    {
        ...
        List<ArraySegment<byte>> _reservQueue = new List<ArraySegment<byte>>();
        ...
        public void FlushSend()
        {
            ...
            lock (_lock)
            {
                ...
                sendList = _reservQueue;
                _reservQueue = new List<ArraySegment<byte>>();
            }
