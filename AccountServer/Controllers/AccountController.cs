...
namespace AccountServer.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public LoginAccountPacketRes LoginAccount([FromBody] LoginAccountPacketReq req)
        {
            ...
            AccountDb account = _context.Accounts
                .AsNoTracking()
                .Where(a => a.AccountName == req.AccountName && a.Passwrd == req.Password)
                .FirstOrDefault();
            ...
            else
            {
                ...
                TokenDb token = _shared.Tokens.Where(t => t.AccountDbId == account.AccountDbId).FirstOrDefault();
                if (token != null)
                {
                    token.Token = new Random().Next(Int32.MinValue, Int32.MaxValue);
